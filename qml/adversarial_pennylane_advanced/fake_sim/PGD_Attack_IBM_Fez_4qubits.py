...
os.makedirs("pictures_IBM_Fez_4qubits", exist_ok=True)
...
def visualize_data(x, y, pred=None, save_name=None):
    ...
    if save_name:
        plt.savefig(os.path.join("pictures_IBM_Fez_4qubits", save_name))
        print(f"Saved image to pictures_IBM_Fez_4qubits/{save_name}")
    # plt.show()
    plt.close()
...
fake_backend = service.backend("ibm_fez")
...
plt.savefig(os.path.join("pictures_IBM_Fez_4qubits", "confusion_matrix_benign.png"))
print("Saved confusion matrix to pictures_IBM_Fez_4qubits/confusion_matrix_benign.png")
plt.close()
...
fig_, ax_ = metric.plot()
plt.savefig(os.path.join("pictures_IBM_Fez_4qubits", "confusion_matrix_adversarial.png"))
print("Saved confusion matrix to pictures_IBM_Fez_4qubits/confusion_matrix_adversarial.png")
plt.close()
...
fig_, ax_ = metric.plot()
plt.savefig(os.path.join("pictures_IBM_Fez_4qubits", "confusion_matrix_robust_model.png"))
print("Saved confusion matrix to pictures_IBM_Fez_4qubits/confusion_matrix_robust_model.png")
plt.close()
