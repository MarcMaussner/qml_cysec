...
""" Omit reshaping -> use original 16*16
...
visualize_data(perturbed_x.reshape(-1, 16, 16), y_vis, adversarial_class_output, save_name="adversarial_attack_evaluation.png")
...
visualize_data(perturbed_x.reshape(-1, 16, 16), y_vis, adversarial_class_output, save_name="robustness_evaluation_after_retraining.png")
